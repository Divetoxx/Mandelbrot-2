...
# Mandelbrot GUI: Visualizer with 1000-Digit Precision and Perturbation Theory
...
# Графический интерфейс Мандельброта: Визуализатор с 1000-значной точностью и методом возмущений
